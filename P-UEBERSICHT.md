...
| **P90** | Selbstheilung für fehlende Pflichtmerkmale (Varianten-Publish) | Direkt nach P-89 live entdeckt: `stele-129` scheiterte am selben errorId 25002, aber für ein anderes Merkmal ("Produktart") — eBays Taxonomy-API meldet nicht zuverlässig jedes Kategorie-Pflichtfeld als "required", das Muster war identisch zu P-89, nur mit anderem Feldnamen. Statt jedes neu auftauchende Merkmal einzeln zu patchen: `publishOfferByInventoryItemGroup` läuft jetzt in einem Retry-Loop, der eBays deutsche Fehlermeldung ("Das Artikelmerkmal X fehlt") per Regex ausliest, X mit Fallback "Nicht angegeben" bei allen Offers nachträgt und erneut publisht — bis zu 5 verschiedene fehlende Merkmale automatisch, bevor aufgegeben wird. Mit gemocktem Live-Aufruf (exakt der stele-129-Fall: 1. Versuch schlägt mit "Produktart fehlt" fehl, 2. Versuch nach Heilung erfolgreich) verifiziert |
